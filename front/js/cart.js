...
function getProducts() {
  ...
  fetch(`http://localhost:3000/api/products/`)
    ...
    .then(function (dataApi) { // mettre les données API dans un tableau
    ...
    .then(function () {
      let basketInTable = [];// mettre le LS dans un tableau
      ...
      if (productLocalStorage != null) { // si panier plein
          ...
          basketInTable.map((basketInTable) => {
            ...
            //if (dataTable._id == basketInTable.id) {
              ...
              basketFull.push({
                ...
                color: basketInTable.color,
                quantity: basketInTable.quantity,
        ...
        //
        // let productInBasket = basketInTable.map((product) => product.id);
        // console.log("mappé !");
