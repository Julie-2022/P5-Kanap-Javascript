...
//       if(productsList === null || productsList === 0 || productsList === [] || productsList === {}) { 
...
//       else{
            ...
            for (let l = 0; l < productsList.length; l++) {
                idProducts.push(productsList[l]); //.idProduct
            }
            ...
            const order = {
                contact: {
                    firstName: "pouet", //inputFirstName.value,
                    lastName: "pouet", //inputLastName.value,
                    address: "pouet", //inputAddress.value,
                    city: "pouet", //inputCity.value,
                    email: "pouet" //inputEmail.value,
                },
                products: idProducts,
            } 
